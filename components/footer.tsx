...
export function Footer() {
  return (
    <footer  className="bg-white ">
      <div className="w-full h-full bg-blue-500 rounded-2xl p-10">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="#" data-scroll-to className="text-white hover:text-black transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <Link href="#features" data-scroll-to className="text-white hover:text-black transition-colors">
                  What We Do?
                </Link>
              </li>
              <li>
                <Link href="#how-it-works" data-scroll-to className="text-white hover:text-black transition-colors">
                  How We Do?
                </Link>
              </li>
              <li>
                <Link href="#faq" data-scroll-to className="text-white hover:text-black transition-colors">
                  FAQ
                </Link>
              </li>
              <li>
